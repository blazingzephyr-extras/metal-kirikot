...
var ReadState_1 = require("./ReadState");
...
var Type = /** @class */ (function () {
     ...
     */
        ...
        if (typeof type === 'string') {
            ...
            var _fieldType_1 = this.type;
            this.fields = Object.keys(type).map(function (name) {
                return new Field_1.Field(name, _fieldType_1[name]);
            });
        }
    }
    /**
    ...
    Type.prototype._readArray = function (type, state) {
        var arr = new Array(this.types.uint.read(state)), j;
